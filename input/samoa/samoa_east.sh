...
export MP_TASK_AFFINITY=core:60
...
#Complex EAST
#disp="tanioka_complex_east_M6.68.nc"
...
#outdir="outputSamoa_tanioka_simple_east_M7.34_points"
outdir="outputSamoa_tanioka_simple_east_M7.34_filtered_Grimsey"
#outdir="outputSamoa_tanioka_simple_east_M7.343"
#outdir="outputSamoa_tanioka_complex_east_M6.68_points"

rm -rf $outdir
mkdir $outdir

cp samoa_east.sh "$outdir/$outdir.txt"
...
/import/freenas-m-05-seissol/SamoaRelated/samoa/bin/samoa_flash -fbath $bathy -fdispl $disp -tmax 2400 -dmin $dmin -dmax $dmax -dcoast $dcoast -tout 10 -max_displacement $displacement_height -displacement_resolution $displacement_resolution -refined_bathymetry $refined_bathymetry -output_dir $outdir -drytolerance $dry_tolerance -sections 1 -courant 0.5 -domain $domain -xdmfoutput -xdmffilterindex 1 -xdmffilterparams 630000 637000 7380000 7388000
# Sig: -xdmffilterindex 1 -xdmffilterparams 594000 599000 7337000 7345000
# Olaf: 604000 612000 7329000 7337000
# Grimsey: 631000, 7381000, 636000, 7387000
